...
public class Builders {
    ...
    public static NetQosPolicyBuilder netQosPolicy() {
        return NeutronNetQosPolicy.builder();
    }

    public static NetQosPolicyUpdateBuilder netQosPolicyUpdate() {
        return NeutronNetQosPolicyUpdate.builder();
    }

    public static NetQosPolicyBandwidthLimitRuleBuilder netQosPolicyBandwidthLimitRule() {
        return NeutronNetQosPolicyBandwidthLimitRule.builder();
    }
}
