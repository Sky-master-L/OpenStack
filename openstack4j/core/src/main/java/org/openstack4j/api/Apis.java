...
public class Apis {
    ...
    /**
     * Gets the (Glance) Metadefs v2 services API
     *
     * @return the metadefs v2 services
     */
    public static MetadefsService getMetadefsService() {
        return get(MetadefsService.class);
    }
